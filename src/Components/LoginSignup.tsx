...
const LoginSignup = () => {
    ...
    const Login = async () => {
        await axios.post(ApiUrl, { username: username, email: email, password: password })
        nav4("/Home")
    }
                ...
                <div className="inputs">
                    <div className="input">
                        <svg width="21" height="21" fill="none" className="inputimg" stroke="#949494" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M20.5 15.5h-7v5h7v-5Z"></path>
                            <path d="M18.5 15.5V14a1.5 1.5 0 1 0-3 0v1.5"></path>
                        </svg>
